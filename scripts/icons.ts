...
//
//   npm run icons              copy every icon the items name that's missing
...
const wanted = args.length ? args : [...new Set(Object.values(ITEMS).flatMap(c => c.art.icons.map(iconName)))]
